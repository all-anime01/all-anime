...
function searchAnime() {
  ...
  var filteredAnime = animes.filter(function (anime) {
  ...
  if (filteredAnime.length === 0) {
    ...
    filteredAnime.forEach(function (anime) {// Código para crear los elementos de resultados
    });
  }
  ...
  filteredAnime.forEach(function (anime) {
    ...
    var animeTitle = document.createElement("span");
    animeTitle.innerHTML = anime.name;
    animeTitle.classList.add("title");
    var animeType = document.createElement("span");
...
var animes = [{
  ...
  image: "https://www.crunchyroll.com/imgsrv/display/thumbnail/480x720/catalog/crunchyroll/ff18ec2d3a400d17921ad9b3a03045ce.jpe",
  type: "ANIME"
}, {
  name: "Beyblade X",
  ...
  image: "https://www.crunchyroll.com/imgsrv/display/thumbnail/480x720/catalog/crunchyroll/48f5e5d1b485eb5c9a33c517accd1fec.jpe",
  type: "ANIME"
}, {
  name: "Black Clover",
  ...
  image: "https://imgsrv.crunchyroll.com/cdn-cgi/image/fit=contain,format=auto,quality=85,width=480,height=720/catalog/crunchyroll/f18cc7982a918da38a3b8e47c4ab6295.jpg",
  type: "ANIME"
}, {
  ...
  image: "https://imgsrv.crunchyroll.com/cdn-cgi/image/fit=contain,format=auto,quality=85,width=480,height=720/catalog/crunchyroll/da1db9f24b365129646e8b4508858217.jpg",
  type: "ANIME"
}, {
  ...
  image: "https://www.crunchyroll.com/imgsrv/display/thumbnail/480x720/catalog/crunchyroll/cbb55a6382682bf71e91f685c6473c5a.jpe",
  type: "ANIME"
}, {
  ...
  image: "https://www.crunchyroll.com/imgsrv/display/thumbnail/480x720/catalog/crunchyroll/00c8ed6414e0ef37dbacf36bec86565a.jpe",
  type: "ANIME"
}, {
  name: "Mob Psycho",
  ...
  image: "https://i2.wp.com/animeyt.es/wp-content/uploads/2023/08/tcSwvmIgrRcH.jpg",
  type: "ANIME"
}, {
  name: "Ousama ranking",
  ...
  image: "https://i3.wp.com/animeyt.es/wp-content/uploads/2023/01/0xkN3SB0azUg.jpg",
  type: "ANIME"
}, {
  ...
  image: "https://dnm.nflximg.net/api/v6/2DuQlx0fM4wd1nzqm5BFBi6ILa8/AAAAQTA0WH6Znc8it-5EP5hduuMVjwyhhGlAt6E33RgLTxjpJDShUnvsirIEq9-fjG1G0Fnf95nVmpDSNZTjLnIrEHwYzwb-wx453ISGixLcJjo_oC5v3Obk8y1n_HhX7Zka8eXqLW5YewPssqDcN2LlEyXX.jpg?r=1f3",
  type: "ANIME"
}, {
  ...
  image: "https://www.crunchyroll.com/imgsrv/display/thumbnail/480x720/catalog/crunchyroll/2995bef133df4020b3acbfe7a694cbdf.jpe",
  type: "ANIME"
}, {
  ...
  image: "https://www.crunchyroll.com/imgsrv/display/thumbnail/480x720/catalog/crunchyroll/5e7f533c3b4f46244ca228af62e83dfa.jpe",
  type: "ANIME"
}, {
...
}, //PELICULAS
{
  ...
  image: "https://gatonplayseries.com/wp-content/uploads/2020/08/9GB2iXCPVP6bgyQXXPUchX8CD7p.jpg",
  type: "PELICULA"
}, {
  ...
  image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRs0VTwEpDc4fcJg_xj4ujt-0nLw8igNL0sU97WeYGFaK_-qI3j4-1lWN7C-dHNUogQaUw&usqp=CAU",
  type: "PELICULA"
}, {
...
var contadorVistas = document.getElementById("vistas"); // Inicializa el contador

var contador = 0; // Función para aumentar el contador y actualizar el contador de vistas

function aumentarContador() {
  contador++;
  contadorVistas.textContent = contador; // Deshabilita el evento de clic para que no se pueda hacer clic nuevamente

  enlace.removeEventListener("click", aumentarContador);
} // Agrega un evento de clic al enlace para aumentar el contador


enlace.addEventListener("click", aumentarContador); //carouser slick
