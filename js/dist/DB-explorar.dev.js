...
var animes = [{
  ...
  name: "Link Click",
  category: "drama",
  image: "https://imgsrv.crunchyroll.com/cdn-cgi/image/fit=contain,format=auto,quality=85,width=480,height=720/catalog/crunchyroll/59a606bb77e39a4935435962ee8d6c4d.jpg",
  link: "https://all-anime.net/ver/Link-click/tv",
  description: "Cheng Xiaoshi entra en el mundo de las fotos de Emma, una empleada de Quede Games, bajo el mando de Lu Guang con el fin de obtener pruebas sobre unos informes financieros falsificados.",
  type: "Sub | Dob",
  seasons: 3,
  episodes: 30
}, {
