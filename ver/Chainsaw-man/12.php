...
<div class="CpCnA">
    ...
    <div class="CapiTop">
        <h1 class="Title" title="Chainsaw man" style="color: #444; font-family: sans-serif;">Espada vs Motosierra</h1>
        <h2 class="SubTitle">Episodio 12</h2>
        ...
        <div class="secciones">
            <article id="tab1">
                ...
                <div class="contenedor">
                    <IFRAME name="ServerC" SRC="https://sbchill.com/e/36w226tmobfz.html" FRAMEBORDER=1 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=YES WIDTH=840 HEIGHT=460 allowfullscreen allow="autoplay"></IFRAME>
                </div>
            </article>
            <!-- <article id="tab2">
